...
public class ExampleParameterController {
	...
	@ResponseBody
//	public Map<String, Object> example6( Map<String, Object> requestBady ) {
	public Map<String, Object> example6( ExampleRequestBodyUser requestBady ) {
		Map<String, Object> resultMap = new HashMap<String, Object>();
		resultMap.put("result", true);
		logger.info("requestBady: {}",requestBady);
